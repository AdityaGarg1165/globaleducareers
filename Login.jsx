import { View, Text,Image,TextInput,Button,TouchableWithoutFeedback} from 'react-native'
...
export default function Login({navigation}) {
  ...
  function login(){
      if(data){
        ...
        if(curruser[0]){
          if (decrypt(curruser[0].password,"mirdul_khota#62490") === password){
            const log = async ()=>{
  ...
  return (
    <View>
        ...
        <TouchableWithoutFeedback onPress={login}>
          <Text style={{backgroundColor:"#5A4BDA",textAlign:"center",height:50,paddingTop:15,width:330,marginLeft:20,marginTop:20,borderRadius:10,fontSize:15,color:'white',overflow:"hidden"}}>Login</Text>
        </TouchableWithoutFeedback>
        {/* <Text style={{backgroundColor:"#ce4027",textAlign:"center",height:50,paddingTop:15,width:350,marginLeft:20,marginTop:20,borderRadius:10,fontSize:15,color:'white'}}>Sign in with google</Text> */}
